  ...
  return (
    ...
    <section className="urgent-cause">
      ...
      <div className="overlay">
        <h1>Urgent Cause</h1>
        <p>
          With support from individuals and corporate donors through the Centre for Family Health Initiative, 
          we create sustainable means of cultivating, supporting lives, families, and the society at large for a 
          healthy and better society within our selected communities.
        </p>
    ...
    <section className="humanity-section">
      <div className="content-container">
        ...
        <div className="text-container">
          ...
          <p>
            A joy for one is joy for all, feel free to contact us if you are currently facing any challenges.
          </p>
          <p>
            Or you want to make someone smile today with your act of charity by supporting our urgent cause with your donation.
          </p>
      ...
      <h2 className="footer-text">Together we can Change<br/> Live For Better.</h2>
    </section>
    <section className="stats-section">
      ...
      <div className="stats-container">
        <div className="stat-item">
          <h2>700+ <br/>volunteers</h2>
        </div>
        <div className="stat-item">
          <h2>85+ <br/>Urgent Causes</h2>
        </div>
        <div className="stat-item">
          <h2>45+ <br/>Urgent Cause<br/>Solved</h2>
        </div>
      </div>
    </section>
